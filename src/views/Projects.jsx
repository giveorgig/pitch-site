...
const Projects = ({ children, offset }) => (
  <>
    <DividerMiddle
      bg="linear-gradient(to right, #4553ff 0%, #4553ff 100%)"
      speed={-0.2}
      offset={`${offset}.1`}
      factor={2}
    />
    ...
    <Divider speed={0.1} offset={offset} factor={2}>
      <UpDown>
        ...
        <SVG icon="upDown" width={8} fill={colors.white} left="70%" top="20%" />
      ...
      <UpDownWide>
        ...
        <SVG icon="circle" width={16} fill={colors.white} left="70%" top="90%" />
